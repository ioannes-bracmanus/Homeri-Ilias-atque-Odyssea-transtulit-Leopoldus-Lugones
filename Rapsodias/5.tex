\setmainhead{\textsc{\emph{Ilíada}, Canto V}}
\bnum
\section*{\centering\textbf{CANTO V}\footT{\ehdos, pp. 113-131, 133-134.}}
\addcontentsline{toc}{subsection}{\textsc{Canto V}}
%
\postart
\textsc{Palas Atena, entonces,} dió audacia y entereza\\
...
\dlog{arráncame del hombro la amarga flecha!}{Dijo,}\\
...
\dlog{para decirle:}{---Pándaro, ¿qué es de tu arco y aladas}\\
...
\dlog{Y contestó el claro hijo de Licaón:}{---Eneas,}\\
...
\dlog{contestó:}{---No me digas que huya o te des trabajo}\\
...
\dlog{capaz de Pelear.}{Díjole así, y Ares le ha dado}\\
...
\dlog{La risueña Afrodita respondióle:}{---Fué el hijo}\\
...
\postart
\setotherline{584}
Antíloco, atacándolo, le hundió en la sien la espada,\\
...
\setotherline{826}
\printlinenum{828}
---Diomedes el Tidida, caro a mi corazón,\\
en adelante, ni a Ares ni a otro inmortal le temas,\\
pues quiero darte ahora toda mi protección.\par
\poend
\separator
%
\postart
\setotherline{835}
Dijo, y asiendo a Esténelo la mano, prontamente\\
lo hizo bajar del carro, donde la diosa ardiente,\\
al lado del divino Diomedes subió en eso.\\
crugió el eje de encina profundamente al peso\\
de la deidad terrible y el varón excelente;\\
y Palas Atenea, tomando fusta y brida,\\
echó a Ares la solípeda yunta, cuando al potente\\
Perifante, el etolio más bravo, hijo eminente\\
de Oquesio, el sangriento Ares quitábale la vida.\\
Atena lleva el casco de Hades, para que el fuerte\\
\dlog{Ares no pueda verla.}{No bien el dios funesto}\\
ve al divino Diomedes, cuando hacia él marcha presto,\\
dejando al formidable Perifante ya inerte,\\
allá en el mismo sitio donde le diera muerte;\\
y así que con el héroe se afronta, una tremenda\\
lanzada le ha tirado por sobre yugo y rienda,\\
para arrancarle el alma. Mas, por su buena suerte,\\
la zarca diosa Atena la ataja con su mano,\\
y por bajo del carro la hace desviarse en vano.\\
A su turno, el valiente Diomedes lo lancea\\
con su pica de bronce, que Palas Atenea\\
dirige al flanco, donde lo ajusta el tahalí;\\
y cuando él rompe hiriéndola su hermosa piel así,\\
retira el arma. Entonces el éneo Ares grita\\
cual nueve o diez mil hombres que la batalla excita,\\
y aqueos y troyanos se extremecen de horror\\
cuando alza el dios siempre ávido de guerra su clamor.\par
Cual negro vapor que entre celajes se condensa,\\
y al ardor de funesta ráfaga asciende entonces,\\
tal Diomedes Tideides vió al grande Ares de bronce\\
subir envuelto en nubes a la extensión inmensa.\par
\poend
\enum