\setmainhead{\textsc{\emph{Ilíada}, Canto I}}
\bnum
\section*{\centering\textbf{CANTO I}\footT{\neh, pp. 58-80.}}
...
\dlog{uno de los aqueos, diciéndoles:}{---Oh Atridas}\\
...
\dlog{flechero Apolo.}{Todos aclaman que se deba}\\
...
\dlog{nos quitará el plageño.}{Dichas estas palabras,}\\
...
\dlog{los arengó:}{---Oh Aquiles, caro a Zeus, pues mandarme}\\
...
\dlog{Contestóle así el rápido Aquiles:}{---Ten confianza,}\\
...
\dlog{a Calcas torvamente, díjole:}{---Mago avieso,}\\
...
\dlog{Agamenón, rey de hombres, repúsole:}{---Huye, pues,}\\
...
\dlog{Y acátanos ya.}{Aquiles de raudos pies contesta:}\\
...
\dlog{Zeus portaégida mora.}{Mas, con nueva querella,}\\
...
\dlog{dijo:}{---Salud, heraldos, mensajeros de Dios}\\
...
a un cetro de oro atadas; con que imploró, no sólo\\
a ambos Atridas, jefes de pueblos, sino a cada\\
\dlog{uno de los aqueos.}{Fué de éstos aclamado,}\\
...
\dlog{Respondióle llorando Tetis:}{---¿Por qué, hijo mío,}\\
...
\dlog{de griterió y Guerra.}{Mas, cuando hubo llegado}\\
...
\dlog{díjole:}{---Algo funesto se apronta, pues con Hera}\\
...
\dlog{Contestó el padre de hombres y dioses:}{---En vano, Hera,}\\
...
\dlog{No indagues ni preguntes.}{Respondió la augusta Hera}\\
\dlog{de ojos de buey:}{---¡Terrible Kronida, qué dijiste!}\\
