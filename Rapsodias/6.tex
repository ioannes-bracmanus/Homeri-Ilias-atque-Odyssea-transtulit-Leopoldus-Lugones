\setmainhead{\emph{\textsc{Ilíada}}, Canto VI}
\bnum
\section*{\centering\textbf{CANTO VI}\footT{\ehuno, pp. 42-43 + \ehdos, pp. 86, 94-97 + \ehctr, pp. 262-265.}}
...
No recuerdo\footE{En el impreso figura como «recuerbo», probablemente un error de imprenta.} a Tideo, puesto que me dejó\\
...
\dlog{y de su mano asiéndole, díjole:}{---Infortunado,}\\
...
Ni está en mi mano hacerlo\footE{En la impresión «hacrelo», otro error.}, que siempre en la porfía\\
...
\dlog{y dícele:}{---Oh, mi triste, no temas por mí, o creas}\\
que alguien me arroje\footE{En el impreso «arorje».} al Hades, contrariando el destino,\\
